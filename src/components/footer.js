            ...
            <>
                <footer id="footer" className="tc-l bg-center cover bg-black">
                    <div className="w-100 ph3 pv4 bg-black-80">
                        ...
                        <a className="link white-60 bg-transparent hover-white inline-flex items-center ma2 tc br2 pa2" href="https://www.instagram.com/ayushibanerjee_/" target='_blank' rel="noopener noreferrer" title=" Twitter">
